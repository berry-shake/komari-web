...
class ReleaseTests(unittest.TestCase):
    ...
    def test_other_baselines_do_not_block_explicit_single_database_release(self):
        check_releases('1.2.3-fork.1', '1.2.3', [{'tag_name':'1.3.2-fork.1', 'draft':False, 'prerelease':False}])
        with self.assertRaises(ValueError):
            check_releases('1.2.3-fork.1', '1.2.3', [{'tag_name':'1.2.3-fork.2', 'draft':False, 'prerelease':False}])
