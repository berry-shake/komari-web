...
// Older and newer upstream baselines remain published only for rollback.
export const isMaintenanceVersion = (tag?: string | null): boolean =>
  /^1\.2\.3-fork\.[1-9][0-9]*$/.test(tag || "");
